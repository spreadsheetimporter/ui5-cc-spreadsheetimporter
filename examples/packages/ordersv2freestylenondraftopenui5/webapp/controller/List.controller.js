sap.ui.define(
	...
	function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment, formatter) {
		...
		return BaseController.extend("ui.v2.ordersv2freestylenondraftopenui5.controller.List", {
			formatter: formatter,
			...
			onOpenViewSettings: function (oEvent) {
				...
				if (!this.byId("viewSettingsDialog")) {
					Fragment.load({
						...
						name: "ui.v2.ordersv2freestylenondraftopenui5.view.ViewSettingsDialog",
						controller: this
					}).then(
						function (oDialog) {
