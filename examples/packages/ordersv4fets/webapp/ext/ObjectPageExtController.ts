import Component, { Component$ChangeBeforeCreateEvent, Component$CheckBeforeReadEvent } from "cc/spreadsheetimporter/v0_24_0/Component";
...
export async function openSpreadsheetUploadDialogTable(this: ExtensionAPI) {
	...
	spreadsheetUpload.attachChangeBeforeCreate((event) => {
		const payload = event.getParameter("payload") as any;
