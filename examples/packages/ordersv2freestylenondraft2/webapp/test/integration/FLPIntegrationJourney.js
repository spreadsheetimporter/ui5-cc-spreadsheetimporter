...
sap.ui.define(["sap/ui/test/opaQunit", "./pages/List", "./pages/Detail"], function (opaTest) {
	"use strict";
	...
	opaTest("Should open the share menu and display the share buttons on the detail page", function (Given, When, Then) {
		// Arrangements
		Given.iStartMyFLPApp({ intent: "uiv2ordersv2freestyle-display" });
		...
		// Assertions
		Then.onTheDetailPage.iShouldSeeTheShareActionButtons().and.theShareTileButtonShouldContainTheRememberedObjectName();
