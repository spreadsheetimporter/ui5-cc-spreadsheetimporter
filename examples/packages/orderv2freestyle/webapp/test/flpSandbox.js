		...
		services: {
								...
								tiles: [
									{
										...
										properties: {
											...
											targetURL: "#uiv2orderv2freestyle-display"
										}
									}
								]
							}
			...
			ClientSideTargetResolution: {
				adapter: {
					config: {
						inbounds: {
							"uiv2orderv2freestyle-display": {
								semanticObject: "uiv2orderv2freestyle",
								action: "display",
								...
								resolutionResult: {
									...
									additionalInformation: "SAPUI5.Component=ui.v2.orderv2freestyle",
									url: sap.ui.require.toUrl("ui/v2/orderv2freestyle")
								}
							}
						}
					}
