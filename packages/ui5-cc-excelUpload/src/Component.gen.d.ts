...
declare module "./Component" {
    ...
    export default interface Component {
        ...
        /**
         * Gets current value of property "excelFileName".
         *
         * Default value is: "Template.xlsx"
         * @returns Value of property "excelFileName"
         */
        getExcelFileName(): string;

        /**
         * Sets a new value for property "excelFileName".
         *
         * When called with a value of "null" or "undefined", the default value of the property will be restored.
         *
         * Default value is: "Template.xlsx"
         * @param [excelFileName="Template.xlsx"] New value for property "excelFileName"
