...
export default class OptionsDialog extends ManagedObject {
  ...
  onSave() {
    this.spreadsheetUploadController.component.setFieldMatchType(
      (this.optionsDialog.getModel('options') as JSONModel).getProperty('/fieldMatchType')
    );
    this.spreadsheetUploadController.component.setStrict((this.optionsDialog.getModel('options') as JSONModel).getProperty('/strict'));
    this.spreadsheetUploadController.component.setDecimalSeparator(
      (this.optionsDialog.getModel('options') as JSONModel).getProperty('/decimalSeparator')
    );
