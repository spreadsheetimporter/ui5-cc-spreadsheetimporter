    ...
    try {
      ...
      if (validationResult.isValid) {
        ...
        const successMessage =
          util.geti18nText('spreadsheetimporter.headerSelectionSuccess') || 'Header row selected successfully. Click Next to continue.';
        ...
        const util = this.wizard.getUtil();
        const errorMessage =
          util.geti18nText('spreadsheetimporter.headerValidationFailed') || 'Header selection failed. Please select a different row.';
