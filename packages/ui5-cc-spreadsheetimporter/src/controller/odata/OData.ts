...
export default abstract class OData extends ManagedObject {
  ...
  public getBindingFromTable(tableObject: any): any {
    ...
    throw new Error(
      `Unsupported table type: ${tableObject.getMetadata().getName()}. Only sap.m.Table, sap.m.List, and sap.ui.table.Table are supported. Alternatively you can specify custom binding in option 'binding'`
    );
  }
