...
```yml
    - name: ui5-middleware-servestatic
      ...
      mountPath: /resources/cc/spreadsheetimporter/v1_1_2/
      configuration:
...
```
<SAP SYSTEM URL>/sap/bc/ui2/app_index/ui5_app_info?id=cc.spreadsheetimporter.v1_1_2
```
...
- name: fiori-tools-proxy
  ...
  configuration:
    backend:
      ...
      - path: /resources/cc/spreadsheetimporter/v1_1_2
        destination: <System Destination name if in BAS>
        pathPrefix: /sap/bc/ui5_ui5/sap/<BSP NAME>/thirdparty/customcontrol/spreadsheetimporter/v1_1_2/
        url: <Cloud Connector or local URL>
```
...
```yml
   - name: ui5-middleware-simpleproxy
      ...
      mountPath: /resources/cc/spreadsheetimporter/v1_1_2/
      configuration:
        baseUri: "<SAP SYSTEM URL>/sap/bc/ui5_ui5/sap/<BSP NAME>/thirdparty/customcontrol/spreadsheetimporter/v1_1_2/"
