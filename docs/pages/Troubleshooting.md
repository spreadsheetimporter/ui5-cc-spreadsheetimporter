...
```
ui5loader-dbg.js:1042 Uncaught (in promise) ModuleError: failed to load 'cc/spreadsheetimporter/v0_31_6/Component.js' from resources/cc/spreadsheetimporter/v0_31_6/Component.js: script load error
```
