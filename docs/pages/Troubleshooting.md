...
```
ui5loader-dbg.js:1042 Uncaught (in promise) ModuleError: failed to load 'cc/spreadsheetimporter/v1_2_0/Component.js' from resources/cc/spreadsheetimporter/v1_2_0/Component.js: script load error
```
