...
For more information, please see the Page [Central Deployment](../../pages/CentralDeployment).

## Setup

Here are the manual steps how to integrate the ui5-cc-excelUpload component. For a simplified integration, a [yo generator](../../pages/Generator) is also available.
...
1\. Execute the deployment with the version you like to use, see here [Central Deployment](../../pages/CentralDeployment).
