...
```xml
<mvc:View controllerName="myapp.controller.Wizard" xmlns:mvc="sap.ui.core.mvc" xmlns:core="sap.ui.core" xmlns="sap.m">
  <Page title="Excel Import Wizard">
    <content>
      <VBox class="sapUiMediumMargin">
        ...
        <Button text="Open Wizard Manually" press="onOpenWizard" type="Emphasized" class="sapUiMediumMarginTop" />
      </VBox>
    </content>
  </Page>
</mvc:View>
